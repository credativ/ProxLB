...
class HaRules:
    ...
    @staticmethod
    def get_ha_rules(proxmox_api: ProxmoxApi, meta: ProxLbData.Meta) -> Dict[str, ProxLbData.HaRule]:
        """
    ...
    @staticmethod
    def get_ha_rules_for_guest(guest_name: str, ha_rules: Dict[str, ProxLbData.HaRule], vm_id: int) -> List[ProxLbData.HaRule]:
        """
        ...
        guest_ha_rules: list[ProxLbData.HaRule] = []

        for rule in ha_rules.values():
            if vm_id in rule.members:
