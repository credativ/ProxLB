...
class Features:
    ...
    @staticmethod
    def validate_any_non_pve9_node(proxlb_config: Config, nodes: Dict[str, Any]) -> ProxLbData.Meta:
        """
        ...
        any_non_pve9_node = any(version.parse(node.get("pve_version", "0.0.0")) < version.parse("9.0.0") for node in nodes.values())
